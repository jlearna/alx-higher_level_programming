...
In this directory we covered some topics on object-relational mapping and how it can be used for
interacting with your database. The code samples in this directory uses MySQLdb and SQLAlchemy to
